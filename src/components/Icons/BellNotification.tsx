...
const BellNotificationIcon: React.FC<IconType> = ({ color, className }) => {
    return <svg className={className} width="19" height="21" viewBox="0 0 19 21" fill="none"
                xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_449_13)">
            <path
